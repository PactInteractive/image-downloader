...
describe('getImageExtension', () => {
	...
	test('extracts extension from simple URLs', () => {
	...
	test('extracts extension from URLs with query parameters', () => {
	...
	test('extracts extension from URLs with hash fragments', () => {
	...
	test('extracts extension from URLs with both query and hash', () => {
	...
	test('returns empty string for data URIs without MIME type', () => {
		expect(getImageExtension('data:text/plain;base64,SGVsbG8=')).toBe('');
	});

	test('handles URLs without extensions', () => {

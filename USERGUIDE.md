...
- Download or view any photo with one click
- Save to a subfolder
...
Image Downloader only retrieves photos currently displayed on the page, which may be thumbnails rather than full-resolution versions (e.g., in Facebook albums). Some sites, like Instagram, load only a few pictures at a time to save bandwidth.

We're exploring ways to improve Image Downloader's capabilities. For now, consider using ther extensions tailored to specific sites (like Facebook or Instagram) for advanced functionality.
